...
const initialState :editBtnState ={
 ...
 export const {setBasicEditBtn,setLocationEditBtn,setMembershipEditBtn,setTimeEditbtn,setAmenitiesEditBtn,setEquipmentEditBtn } = editFacilityBtnSlice.actions;
