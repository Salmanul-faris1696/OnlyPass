...
import FDbasicInfo from '../components/FD data components/FDbasicInfo';
import FDlocationInfo from '../components/FD data components/FDlocationInfo';
import FDmembershipInfo from '../components/FD data components/FDmembershipInfo';
import FDtimeInfo from '../components/FD data components/FDtimeInfo';
import FDamenitiesInfo from '../components/FD data components/FDamenitiesInfo';
...
const FacilitiesDetails: React.FC = () => {
  ...
  const Links = [
    {
      id: 1,
      path:<Link to="/FDbasicInfo">Basic Information</Link>
      
    },
    {
      id: 2,
      path:<Link to="/FDlocationInfo">Location Information</Link>
      
    },
    {
      id: 3,
      path:<Link to="/FDlocationInfo">Membership Options</Link>
      
    },
    {
      id: 4,
      path:<Link to="/FDlocationInfo">Amenities</Link>
      
    },
     {
      id: 5,
      path:<Link to="/FDlocationInfo">Equipments</Link>
    },
